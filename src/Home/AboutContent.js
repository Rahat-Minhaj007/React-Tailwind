...
import img1 from '../images/hero2.svg';
import img2 from '../images/hero3.svg';
import img3 from '../images/hero4.svg';
import img4 from '../images/hero5.svg';
            ...
            <div class="container px-5 py-24 mx-auto">
                <div class="flex flex-wrap w-full mb-20">
                    <div class="lg:w-1/2 w-full mb-6 lg:mb-0">
                        <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">About Our Work</h1>
